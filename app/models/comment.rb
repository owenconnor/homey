class Comment < ApplicationRecord
  ...
  def create_news_item
    NewsItem.create(title: "New comment on #{self.commentable.name}", body: self.body, news_itemable_type: "Comment", news_itemable_id: id, project_id: self.commentable_id, user_id: self.user_id)
  end
end
